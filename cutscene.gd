...
var slides := [
	...
	},
	{
		...
		"audio": preload("res://cutscene/slide6.mp3"),
	},
	{
		"texture": preload("res://cutscene/slide7.jpg"),
		"subtitle": "", # or "SHATTERED TOWERS"
		"audio": preload("res://cutscene/slide7.mp3"),
	},
]
...
func _ready() -> void:
	...
	subtitle_label.add_theme_color_override("font_outline_color", Color(0, 0, 0, 0.9))
