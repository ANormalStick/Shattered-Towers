# door.gd
#######################################################
# Durvju objekta skripts.
# Nodrošina durvju atvēršanu ar atslēgu un pāreju
# uz nākamo līmeni ar fade efektu.
#######################################################
# Autors:    Jānis Mārtiņš Īvāns (JI23010)
# Radīts:    v1.0; 2025.12.15. - Izveidota durvju sistēma
...
@export var next_level: String = ""  # piem., "res://level_2.tscn"
...
func _ready() -> void:
	...
	# Sāk ar 0. kadru (aizvērtas durvis)
	anim.stop()
	anim.frame = 0
	
	# Inicializē fade tābulu (pilnigi caurspīdīga)
	if fade_rect:
		fade_rect.color = Color(0, 0, 0, 0)
		fade_rect.visible = true
	
	# Izveido ziņojuma tekstu "Nepieciešama atslēga"
	_create_message_label()

# Izveido ziņojuma tekstu "Nepieciešama atslēga"
func _create_message_label() -> void:
	message_label = Label.new()
	message_label.text = "Nepieciešama atslēga"
...
# Izsaukts, kad spēlētājs ieiet durvju zonā
...
# Izsaukts, kad spēlētājs iziet no durvju zonas
func _on_body_exited(body: Node2D) -> void:
	if body == player_ref:
		player_in_door = false
		player_ref = null

# Mēģina atvērt durvis ar atslēgu
func _try_open_door() -> void:
	...
	if GS and GS.has_key:
		is_open = true
		GS.has_key = false  # Izmanto atslēgu
		
		# Atskaņo durvju atvēršanas animāciju un skaņu
		door_audio.play()
		anim.play("Door")
	else:
		# Parāda "Nepieciešama atslēga" ziņojumu
		_show_key_required_message()

# Parāda ziņojumu par nepieciešamo atslēgu
...
# Ieiet durvīs un pāriet uz nākamo līmeni
...
# Pakāpeniska pāreja uz melnu ekrānu
...
func _on_animation_finished() -> void:
	pass  # Durvis paliek atvērtas pēc animācijas
